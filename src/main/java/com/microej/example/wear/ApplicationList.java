...
public class ApplicationList extends Container implements Swipeable {
	...
	protected void onHidden() {
		...
		// save the current selected position in the list before leaving
		WatchExample.setCurrentPosition(this.selectedIndex);
	}
	...
	protected void layOutChildren(int contentWidth, int contentHeight) {
		...
		if (widgetsCount > 0) {
			...
			this.swipeEventHandler = new SwipeEventHandler(widgetsCount, height, false, true, false, this,
